-- Setup database untuk sistem auth MAKNA
-- Script ini perlu dijalankan di Supabase SQL editor
...
-- Fungsi untuk registrasi user (opsional - bisa pakai auth.signUp dari client)
...
begin
  ...
  -- Buat user di auth.users menggunakan Supabase Auth (ini akan dipanggil dari client)
  -- Fungsi ini hanya untuk validasi tambahan dan bisa dipanggil dari client
